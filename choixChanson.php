...
curl_setopt_array($curl, [
    ...
    CURLOPT_HTTPHEADER => [
        ...
        "X-RapidAPI-Key: 0fb59101e8msh5e994f7f9e80f1ep111c7ajsnd1bf91147885"
    ],
]);
...
foreach($data as $dat){
    ...
    echo
    "
     <div class='d-flex flex-lg-row   flex-column mx-md-5  justify-content-center '> 
    ...
    <div class='card text-center m-auto text-center '>
       ...
       <div class='text-center mt-2'>  <a href='choixChanson.php?img=".$img."&titre=".$titre."&artiste=".$artiste."' class='bouncy btn btn-primary btn-outline-warning text-white w-50 '> <strong>VALIDER</strong></a></div>
    </div>       
        </div>
        </div>
